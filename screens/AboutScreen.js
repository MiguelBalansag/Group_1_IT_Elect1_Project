...
const AboutScreen = () => {
    ...
    const teamMembers = [
        ...
        },
        {
            ...
            email: 'jane.smith@flashcard.com',
            hobbies: ['Digital Art', 'Yoga', 'Photography', 'Traveling'],
            bio: 'Creative designer focused on user-centered design. Believes great design should be invisible.',
            isLead: false,
        },
        {
            id: 3,
            ...
            email: 'mike.johnson@flashcard.com',
            hobbies: ['Rock Climbing', 'Gaming', 'Cooking', 'Hiking'],
            bio: 'Backend wizard specializing in scalable systems. Coffee addict and problem solver.',
            isLead: false,
        },
        {
            id: 4,
            ...
            email: 'sarah.wilson@flashcard.com',
            hobbies: ['Running', 'Podcasts', 'Board Games', 'Gardening'],
            bio: 'Strategic thinker who bridges the gap between users and developers. Marathon runner and team motivator.',
            isLead: false,
        },
        {
            id: 5,
            ...
            email: 'david.brown@flashcard.com',
            hobbies: ['Machine Learning', 'Piano', 'Basketball', 'Writing'],
            bio: 'AI enthusiast pushing the boundaries of educational technology. Loves experimenting with new models.',
            isLead: false,
        },
        {
            id: 6,
            ...
            email: 'emily.davis@flashcard.com',
            hobbies: ['Bug Hunting', 'Baking', 'Knitting', 'Mystery Novels'],
            bio: 'Detail-oriented tester who finds bugs before users do. Perfectionist with a sweet tooth.',
            isLead: false,
        },
        {
            id: 7,
            ...
            email: 'robert.miller@flashcard.com',
            hobbies: ['Automation', 'Cycling', 'Drone Flying', 'Astronomy'],
            bio: 'Infrastructure expert keeping everything running smoothly. Believes in automation over repetition.',
            isLead: false,
        },
        {
            id: 8,
            ...
            email: 'lisa.taylor@flashcard.com',
            hobbies: ['Writing', 'Meditation', 'Dance', 'Language Learning'],
            bio: 'Wordsmith crafting engaging content. Fluent in 4 languages and always learning more.',
            isLead: false,
        },
        {
            id: 9,
            ...
            email: 'james.anderson@flashcard.com',
            hobbies: ['Mobile Apps', 'Soccer', 'Music Production', 'Surfing'],
            bio: 'Mobile-first developer creating smooth, responsive experiences. Beach lover and tech enthusiast.',
            isLead: false,
        },
        {
            id: 10,
            ...
            email: 'amy.thomas@flashcard.com',
            hobbies: ['Data Visualization', 'Painting', 'Tennis', 'Volunteering'],
            bio: 'Numbers tell stories, and she tells them beautifully. Turns data into actionable insights.',
            isLead: false,
        },
        {
            id: 11,
            ...
            age: 33,
            birthday: 'May 7, 1991',
            email: 'chris.white@flashcard.com',
            hobbies: ['Social Media', 'Skiing', 'Stand-up Comedy', 'Craft Beer'],
            bio: 'Creative marketer spreading the word about great products. Always has a joke ready.',
            isLead: false,
        },
    ];
